...
public class ShowAuthorsActivity extends Activity {
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        //static final String[] authorList = new String[] {
	        //    "Pat FitzGerald", "Lee Cherry", "Stacie McGowan", "Melissa Church"
	        //  };
	        ...
	        Log.i("inside ShowAuthorsActivity","ShowAuthorsActivity onCreate");
